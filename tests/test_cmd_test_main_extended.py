...
def test_file_path_parameters_passed_to_generate_test(mock_ctx, basic_inputs):
    ...
    with patch("pdd.cmd_test_main.construct_paths") as mock_construct_paths, \
        ...
        # Configure resolve to return the path string
        mock_path_instance.expanduser.return_value.resolve.return_value = "/home/user/src/my_module.py"
        ...
        assert call_kwargs["source_file_path"] == "/home/user/src/my_module.py"
...
def test_coverage_enhancement_with_merge_mode(mock_ctx, basic_inputs):
    ...
    with patch("pdd.cmd_test_main.construct_paths") as mock_construct_paths, \
        ...
        write_calls = [c for c in mock_file.mock_calls if 'test_existing.py' in str(c)]
